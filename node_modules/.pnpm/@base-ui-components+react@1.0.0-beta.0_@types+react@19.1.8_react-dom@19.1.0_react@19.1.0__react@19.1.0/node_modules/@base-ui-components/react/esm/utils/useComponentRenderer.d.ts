...
export interface ComponentRendererSettings<State, RenderedElementType extends Element> {
   ...
   */
  render: ComponentRenderFn<HTMLProps, State> | React.ReactElement<Record<string, unknown>> | keyof React.JSX.IntrinsicElements;
  /**
 ...
 */
export declare function useComponentRenderer<State extends Record<string, any>, RenderedElementType extends Element>(params: ComponentRendererSettings<State, RenderedElementType>): {
