...
import { ALL_KEYS, ARROW_DOWN, ARROW_KEYS, ARROW_LEFT, ARROW_RIGHT, ARROW_UP, END, HOME, HORIZONTAL_KEYS, HORIZONTAL_KEYS_WITH_EXTRA_KEYS, MODIFIER_KEYS, VERTICAL_KEYS, VERTICAL_KEYS_WITH_EXTRA_KEYS, createGridCellMap, findNonDisabledListIndex, getGridCellIndexOfCorner, getGridCellIndices, getGridNavigatedIndex, getMaxListIndex, getMinListIndex, isListIndexDisabled, isIndexOutOfListBounds, getTextDirection, isNativeInput } from "../composite.js";
...
export function useCompositeRoot(params) {
  ...
  const onMapChange = useEventCallback(map => {
    ...
    const activeIndex = sortedElements.findIndex(compositeElement => compositeElement?.hasAttribute(ACTIVE_COMPOSITE_ITEM));
    if (activeIndex !== -1) {
  ...
  }), [cols, dense, disabledIndices, elementsRef, enableHomeAndEndKeys, highlightedIndex, isGrid, itemSizes, loop, mergedRef, modifierKeys, onHighlightedIndexChange, orientation, stopEventPropagation]);
