...
export function useSelectPopup() {
  ...
  useModernLayoutEffect(() => {
    if (alignItemWithTriggerActive || !positionerElement || Object.keys(originalPositionerStylesRef.current).length) {
      return;
    }
  ...
  useModernLayoutEffect(() => {
    if (!mounted || !alignItemWithTriggerActive || !triggerElement || !positionerElement || !popupRef.current) {
      return;
    }
  ...
  }, [mounted, positionerElement, triggerElement, valueRef, selectedItemTextRef, popupRef, setScrollUpArrowVisible, setScrollDownArrowVisible, handleScrollArrowVisibility, alignItemWithTriggerActive, setControlledItemAnchor]);
  React.useEffect(() => {
